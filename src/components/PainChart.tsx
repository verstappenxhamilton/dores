    ...
    return (
        ...
        <Paper elevation={3} sx={{ width: '100%', maxWidth: '100%', mx: 'auto', p: 4, mt: 4, background: 'rgba(40,40,40,0.95)', borderRadius: 3 }}>
            <div style={{ position: 'relative', minHeight: 500, width: '100%' }}>
                ...
                <Line ref={chartRef} data={chartData} options={options} height={500} onClick={e => handlePointClick(e, chartRef)} />
            </div>
        </Paper>
        <Dialog fullScreen open={fullscreen} onClose={() => setFullscreen(false)}>
            <DialogContent sx={{ bgcolor: 'background.default', p: 2 }}>
                ...
                <div style={{ minHeight: 500 }}>
                    <Line ref={dialogChartRef} data={chartData} options={options} height={500} onClick={e => handlePointClick(e, dialogChartRef)} />
                </div>
            </DialogContent>
        </Dialog>
